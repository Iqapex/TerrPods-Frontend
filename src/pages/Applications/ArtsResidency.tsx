...
const TERRAPODS_YELLOW_DARK = "#b38a00";  // Hover Yellow
...
const ArtsResidency = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/programs/artsResidency")
  ...
  if (!data.length)
    return (
      <div className="container mx-auto pt-42 px-8 text-center">
        <p className="text-lg text-gray-600">No residency applications yet.</p>
      </div>
    );
